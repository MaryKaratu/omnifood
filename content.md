...
Box-shade;0 0 0 3px #fff

<!-- Put transition on the oriinal state -->

transition:(or bot) background color 0.3s(popularly used)

<!-- because we want the navigation to be sticky later we defined the height on the nav element -->
...
/_ 1140px _/
max-width: 120rem;
padding: 0 3.2rem;(for making content no glued to the sides of thr view point)
margin: 0 auto;
}
